<template>
  <div id="table" class="container">
    ...
    <section class="container-cart">
      ...
      <TableRow :rank="Number(2)" :username="data.find((item) => item.rank === '1')?.username"
      ...
      <TableRow v-for="(item, index) in data.slice(1, 7)" :key="index" :rank="+item.rank + 3" :username="item.username"
